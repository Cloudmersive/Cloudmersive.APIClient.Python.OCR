...
> FormRecognitionResult image_ocr_photo_recognize_form(image_file, form_template_definition=form_template_definition, recognition_mode=recognition_mode, language=language)
...
try:
    # Recognize a photo of a form, extract key fields and business information
    api_response = api_instance.image_ocr_photo_recognize_form(image_file, form_template_definition=form_template_definition, recognition_mode=recognition_mode, language=language)
    pprint(api_response)
except ApiException as e:
...
> ReceiptRecognitionResult image_ocr_photo_recognize_receipt(image_file, form_template_definition=form_template_definition, recognition_mode=recognition_mode, language=language)
...
try:
    # Recognize a photo of a receipt, extract key business information
    api_response = api_instance.image_ocr_photo_recognize_receipt(image_file, form_template_definition=form_template_definition, recognition_mode=recognition_mode, language=language)
    pprint(api_response)
except ApiException as e:
